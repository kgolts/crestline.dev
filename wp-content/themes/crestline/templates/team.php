...
<div id="primary" class="content-area about team">
    ...
    <div class="container-fluid">
         <?php  if( $first_row_image && $second_row_image  && $third_row_image): ?>
		<div class="row">
                <div class="col-sm-12">
    ...
    <?php if( have_rows('image_layout_top') ): // check if the flexible content field has rows of data ?>
    
   <?php  while ( have_rows('image_layout_top') ) : the_row();  // loop through the rows of data ?>
