<?php
// Template Name: Jobs Landing
?>
<?php get_header(); ?>

<div id="primary" class="content-area page projects jobs">
                                ...
                                ?>
                                    ...
                                    <div class="col-sm-4">
                                         <?php if($url != '') : ?>
                                            ...
                                            <div class="bg-img relatedprojects" style="background-image: url('<?php echo $url ?>')">
                                       ...
                                       <div class="txt"> 
                                        ...
                                        <p><?php echo wp_trim_words( $content, 40 )  ?></p>
                                         <a href="<?php echo get_page_link( $page->ID ); ?>" class="link">VIEW FULL JOB DESCRIPTION</a>
                                        </div>
                                    </div>
                                <?php
                                    $counter++;
